...
<figure>
    <img src="./assets/Maya.jpg" alt="3D model of the V02 wiper in Maya with its sizes in cm" style="max-height: 300px"/>
  <figcaption><em>3D model of the V02 wiper in Maya with its sizes in cm</em></figcaption>
</figure>
<figure>
